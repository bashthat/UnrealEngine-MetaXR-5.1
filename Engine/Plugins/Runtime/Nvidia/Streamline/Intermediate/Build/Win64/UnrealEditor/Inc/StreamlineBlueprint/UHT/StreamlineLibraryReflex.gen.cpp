...
// End Cross Module References
	...
	static UEnum* UStreamlineReflexMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_UStreamlineReflexMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexMode, Z_Construct_UPackage__Script_StreamlineBlueprint(), TEXT("UStreamlineReflexMode"));
		}
	...
	static FEnumRegistrationInfo Z_Registration_Info_UEnum_UStreamlineReflexSupport;
	static UEnum* UStreamlineReflexSupport_StaticEnum()
	{
		if (!Z_Registration_Info_UEnum_UStreamlineReflexSupport.OuterSingleton)
		{
			Z_Registration_Info_UEnum_UStreamlineReflexSupport.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport, Z_Construct_UPackage__Script_StreamlineBlueprint(), TEXT("UStreamlineReflexSupport"));
		}
		return Z_Registration_Info_UEnum_UStreamlineReflexSupport.OuterSingleton;
	}
	template<> STREAMLINEBLUEPRINT_API UEnum* StaticEnum<UStreamlineReflexSupport>()
	{
		return UStreamlineReflexSupport_StaticEnum();
	}
	struct Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/StreamlineLibraryReflex.h" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_StreamlineBlueprint,
		nullptr,
		"UStreamlineReflexSupport",
		"UStreamlineReflexSupport",
		Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport()
	{
		if (!Z_Registration_Info_UEnum_UStreamlineReflexSupport.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_UStreamlineReflexSupport.InnerSingleton, Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport_Statics::EnumParams);
		}
		return Z_Registration_Info_UEnum_UStreamlineReflexSupport.InnerSingleton;
	}
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UStreamlineLibraryReflex_QueryReflexSupport_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(StreamlineLibraryReflex_eventQueryReflexSupport_Parms, ReturnValue), Z_Construct_UEnum_StreamlineBlueprint_UStreamlineReflexSupport, METADATA_PARAMS(nullptr, 0) }; // 3834451774
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UStreamlineLibraryReflex_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UStreamlineLibraryReflex_GetDefaultReflexMode, "GetDefaultReflexMode" }, // 2713960700
		{ &Z_Construct_UFunction_UStreamlineLibraryReflex_GetGameLatencyInMs, "GetGameLatencyInMs" }, // 3478792550
		{ &Z_Construct_UFunction_UStreamlineLibraryReflex_GetGameToRenderLatencyInMs, "GetGameToRenderLatencyInMs" }, // 2199257814
		{ &Z_Construct_UFunction_UStreamlineLibraryReflex_GetReflexMode, "GetReflexMode" }, // 2375084029
		{ &Z_Construct_UFunction_UStreamlineLibraryReflex_GetRenderLatencyInMs, "GetRenderLatencyInMs" }, // 1115575027
		{ &Z_Construct_UFunction_UStreamlineLibraryReflex_IsReflexSupported, "IsReflexSupported" }, // 810992378
		{ &Z_Construct_UFunction_UStreamlineLibraryReflex_QueryReflexSupport, "QueryReflexSupport" }, // 2133243008
		{ &Z_Construct_UFunction_UStreamlineLibraryReflex_SetReflexMode, "SetReflexMode" }, // 979753329
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibraryReflex_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibraryReflex_h_Statics::EnumInfo[] = {
		...
		{ UStreamlineReflexSupport_StaticEnum, TEXT("UStreamlineReflexSupport"), &Z_Registration_Info_UEnum_UStreamlineReflexSupport, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3834451774U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibraryReflex_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStreamlineLibraryReflex, UStreamlineLibraryReflex::StaticClass, TEXT("UStreamlineLibraryReflex"), &Z_Registration_Info_UClass_UStreamlineLibraryReflex, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStreamlineLibraryReflex), 2526511032U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibraryReflex_h_2140631693(TEXT("/Script/StreamlineBlueprint"),
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibraryReflex_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibraryReflex_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibraryReflex_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Nvidia_Streamline_Source_StreamlineBlueprint_Public_StreamlineLibraryReflex_h_Statics::EnumInfo));
